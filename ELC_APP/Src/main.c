...
extern const float SMon_P_L1Correction;
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc)
{
	...
	{
		adcclamped = (float)Ain_DmaBuffer[4];
	}
	...
	v4 = ((float)SMon_P_NTC_PullUp_ResistorVale * (float)Ain_DmaBuffer[4u]) / diff_adcmax_dmabuff;  // ntc
