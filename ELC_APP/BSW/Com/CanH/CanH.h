...
#define CANH_LOADREQ_TIMEOUT_TICKS   (20u)   /* e.g. 50 ms */
...
extern Xcp_Security_t Xcp_Security;
...
extern uint8_t CanH_RequestBusSleep;
...
extern volatile uint32_t CanH_CRC_LoadRequest;
...
extern void HAL_CAN_RxFifo0MsgFullCallback(CAN_HandleTypeDef *hcan);
extern void HAL_CAN_RxFifo1MsgPendingCallback(CAN_HandleTypeDef *hcan);
extern void HAL_CAN_RxFifo1MsgFullCallback(CAN_HandleTypeDef *hcan);
