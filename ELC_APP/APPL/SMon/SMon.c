...
static void SMon_ProcessLoadErrorStatus(void)
{
	...
	if (SMon_NTC_Temperature_L1 > SMon_P_NTCTemperatureMax)
	{
	    if (localTimeStamp3 == 0u)
	    {
	        localTimeStamp3 = SMon_MainCnt;
	    }

	    if ((SMon_MainCnt - localTimeStamp3) >= SMon_P_WaitTimeOVUV)
	    {
	        if (SMon_NtcError == 0u)
	        {
	            SMon_RequestPhysicalStatus = 0u;
	...
	else if (SMon_NTC_Temperature_L1 < SMon_P_NTCTemperatureRelease)
	{
	    if (localTimeStamp3 == 0u)
	    {
	        localTimeStamp3 = SMon_MainCnt;
	    ...
	    if ((SMon_MainCnt - localTimeStamp3) >= SMon_P_WaitTimeOVUV)
	    {
	        if (SMon_NtcError == 1u)
	        {
	            ...
	            if (Dem_GetDtcStatus(0x58u) == 0x2f)
	            {
