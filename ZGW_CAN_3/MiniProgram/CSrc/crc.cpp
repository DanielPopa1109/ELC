...
s32 CRC8_E2E_P11(pu8 data, s32 datalen);
...
// CODE BLOCK BEGIN Custom_Function CRC8_E2E_P11 cHU4IGRhdGEsIHMzMiBkYXRhbGVu
// Custom Function "CRC8_E2E_P11"
s32 CRC8_E2E_P11(pu8 data, s32 datalen) { try { // Custom Function: 
    /****************************Info**********************************************
     * Name:    CRC-8 E2E_P11          x8+x4+x3+x2+1
     * Width:	8
     * Poly:    0x1D
     * Init:    0xFF
     * Refin:   False
...
/* 
[UI]
UICommon=-1,-1,-1,0,QyBDb2RlIEVkaXRvciBbY3JjXQ__,100,338,1646347185747603525,0
ScriptName=crc
DisplayName=crc
IsMPLib=1
DBDeps=ZGW_CAN_3
LastBuildTime=2026-06-26 23:10:12
VarListClose=1
CompileListClose=1
APICnt=22*/
